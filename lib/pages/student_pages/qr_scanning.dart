...
class _QrPageState extends State<QrPage> {
      ...
      if (result != null && loops <= 0) {
        ...
        if (scannedData != null) {
          ...
          if (decryptedData != null) {
            ...
            context.read<UserBloc>().add(FetchCanteenUserNameEvent(decryptedData));
          } else {
          ...
          actions: <Widget>[
            ...
            CupertinoDialogAction(
              ...
              onPressed: () {
                ...
                context.read<UserBloc>().add(ScannedDataEvent(result!, val, widget.studentUserId));
                context.read<UserBloc>().add(UpdateCanteenCountEvent(val, canteenUserId));
  ...
  void _navigateBackToStudentPage(BuildContext context) {
    Navigator.of(context).pushAndRemoveUntil(
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) => const StudentHome(),
